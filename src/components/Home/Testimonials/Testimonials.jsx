...
const testimonialsCards = [
  {
    ...
    cardText: `As a startup, we needed a website that could showcase our unique
            ...
            team at WeXcute delivered just that! They designed an
...
const Testimonials = () => {
  ...
  return (
    <Stack spacing={5} bgcolor="primary.blue" paddingY={'80px'} width={'100%'} paddingX={'24px'}>
      ...
      <Box>
        <Carousel
          navButtonsAlwaysVisible={!isMobileView && !isTabletView ? true : false}
          autoPlay={false}
          fullHeightHover={true}
          animation="slide"
          NextIcon={<PlayArrowIcon sx={{ color: '#F5F5F5' }} />}
          PrevIcon={<PlayArrowIcon sx={{ color: '#F5F5F5', transform: 'rotate(180deg)' }} />}
          navButtonsProps={{
            style: {
