    ...
    <Stack spacing={10} sx={{ maxWidth: 1200, width: '100%' }}>
      <Stack spacing={3} sx={{ padding: '0 24px' }}>
        ...
        <Typography variant="body2" align="center">
          At WeXcute, our customer-centric approach ensures a seamless experience from the moment you reach out to us until your digital
          solution is launched and beyond. Our detailed work process, rooted in software engineering best practices, is designed to deliver
          exceptional results while fostering a collaborative partnership with you. We're proud of our 4D development process, but in the
          spirit of full transparency, we want you to know about the additional steps that make our process even more comprehensive. So,
          let's dive into the intricate stages of our workflow, where we leave no stone unturned.
        </Typography>
      </Stack>
          ...
          >
            <CardContent>
              <Stack direction={isMobileView ? 'column' : 'row'} spacing={4}>
                <Stack
                  direction={isMobileView ? 'column' : card.isImageStyled ? 'row' : 'row-reverse'}
                  alignItems="center"
                  justifyContent="space-around"
                  sx={{ maxWidht: 560, width: '100%' }}
                >
                  <Image src={card.cardIcon} alt={'card image'} width={120} height={120} />
                  <Typography variant="h5" sx={{ color: '#E41469', maxWidth: '320px' }} align="center">
                    {card.cardTitle}
                  </Typography>
                </Stack>

                <Stack sx={{ maxWidht: 560, width: '100%', justifyContent: 'center' }}>
      ...
      <Stack sx={{ padding: '0 24px' }}>
        <Typography variant="body1" sx={{ color: '#E41469' }} align="center" fontWeight={500}>
          With our transparent, structured, and collaborative approach, WeXcute guarantees a smooth digital product development process and
          exceptional results that elevate your business. Reach out to us today to start your journey towards digital success.
        </Typography>
      </Stack>
    </Stack>
  );
